 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Sun Feb 01 02:43:32 2026
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                control_sfunc_1
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port u0 of S-Function control_sfunc_1");
      return;
    }
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port y0 of S-Function control_sfunc_1");
      return;
    }
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  control_sfunc_1_Outputs_wrapper(u0, y0);
}
